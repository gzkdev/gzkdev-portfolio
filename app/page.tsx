      ...
      <div className="grid-item top-0 lg:sticky lg:col-[1/3] lg:row-[1/6]">
        <div className="wrapper h-full w-full  lg:text-start">
          ...
          <div className="flex w-full flex-col gap-5 px-5 py-5 pb-10 lg:items-start lg:pb-5">
            <div className="relative aspect-square w-full max-w-[144px] overflow-hidden rounded border-[4px] border-teal-500 grayscale-[50%] transition hover:grayscale-[30%]">
      ...
      <div className="grid-item lg:col-[1/3] lg:row-[6/7]">
        <div className="wrapper h-full">
          <div className="flex h-full w-full flex-col">
            <div className="flex flex-col gap-5 px-5 pb-16 lg:pb-5">
              <ul className="flex w-full items-center justify-center gap-6 text-2xl lg:justify-start">
                <li>
                  <a
                    href="http://#"
                    target="_blank"
              ...
              <div className="text-center lg:text-start">
                ...
                <a
                  href="#"
                  className="text-teal-300 underline decoration-dotted underline-offset-2"
                >
                  gzkdev
                </a>
              </div>
